                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-1 order-md-1 order-2">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8"><input type="text" name="registration_number"
                                                                             value="@if($transaction){{$transaction->id+1}} @else 1 @endif"
                                                                             class="form-control bg-gray-light"></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label col-sm-4">التاريخ</label>
                                                <div class="col-sm-8"><input type="text" name="date" required
                                        ...
                                        <div class="col-md-4 mb-1 order-md-1 order-3">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="branch" class="form-control bg-gray-light">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8"><input name="type" type="text"
                                                                             class="form-control bg-gray-light"></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="card shadow-none m-0">
                                                <div class="card-body table-responsive p-0" style="height:250px;">
                                                    <table
                                                        class="table table-head-fixed text-nowrap table-striped-td table-input-td text-center"
                                                        id="add-table">
                                                        <thead>
                                                        <tr>
                                                            <th>اسم الحساب</th>
                                                        ...
                                                        <tr id="entryrow_1">
                                                            <td>
                                                                <select required data-type="name" class="form-control "
                                                                        id="name_1" name="names[]" autocomplete="off">
                                                            ...
                                                            <td>
                                                                <select required data-type="name" class="form-control "
                                                                        id="name_1" name="number[]" autocomplete="off">
                                                                    @foreach($accounts as $account)
                                                                        <option value="{{$account->id}}">
                                                                            {{$account->number}}
                                                            ...
                                                            <td><input type="text"
                                                                       ...
                                                                       id="debtor_1" name="debtor[]"></td>
                                                            <td><input type="text"
                                                                       class="form-control bg-transparent border-0 inputs"
                                                                       id="creditor_1" name="creditor[]"></td>
                                                            <td><input type="text"
                                                                       class="form-control bg-transparent border-0 inputs sal-lst"
                                                                       id="statement_1" name="statement[]"></td>
                                                            <td></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
        ...
        var AddMultiAutoField = (function () {
            ...
            function formHtml(code) {
                ...
                if (code == 13 && rowId == 'entryrow') {
                    ...
                    html += '<td> <select  required  class="form-control " id="name_' + rowcount + '" name="number[]" autocomplete="off">' +
