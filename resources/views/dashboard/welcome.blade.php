                                    ...
                                    <div class="card animate fadeLeft">
                                        <div class="card-content cyan white-text">
                                            <p class="card-stats-title"><i
                                                    class="material-icons">person_outline</i> @lang('site.companies')
                                            </p>
                                            <h4 class="card-stats-number white-text count">{{\App\Models\Company::count()}}</h4>
                                            <p class="card-stats-compare">
                                                <i class="material-icons">face</i>
                                                <span class="cyan text text-lighten-5">
                                                        <a href="{{ route('dashboard.companies.index') }}"
                                                           style="color: #e2e3e3">@lang('site.read') </a>
                                ...
                                <div class="col s12 m6 l3">
                                    <div class="card animate fadeLeft">
                                        <div class="card-content red accent-2 white-text">
                                            <p class="card-stats-title"><i
                                                    class="material-icons">photo_filter </i> @lang('site.sliders')</p>
                                            <h4 class="card-stats-number white-text count">{{\App\Models\Slider::count()}}</h4>
                                            <p class="card-stats-compare">
                                ...
                                <div class="col s12 m6 l3">
                                    <div class="card animate fadeRight">
                                        <div class="card-content orange lighten-1 white-text">
                                            <p class="card-stats-title"><i
                                                    class="material-icons">invert_colors</i> @lang('site.services')</p>
                                            <h4 class="card-stats-number white-text count">{{\App\Models\Service::count()}}</h4>
                                            <p class="card-stats-compare">
                                                <i class="material-icons">face</i>
                                ...
                                <div class="col s12 m6 l3">
                                    <div class="card animate fadeRight">
                                        <div class="card-content green lighten-1 white-text">
                                            <p class="card-stats-title"><i
                                                    class="material-icons">content_copy</i> @lang('site.inquiries')</p>
                                            <h4 class="card-stats-number white-text count">{{\App\Models\Contact_u::count()}}</h4>
                                            <p class="card-stats-compare">
                                                <i class="material-icons">face</i>
                                ...
                                <div class="col s12 m12 l4">
                                    <div id="profile-card" class="card animate fadeRight">
                                        <div class="card-image waves-effect waves-block waves-light">
                                            <img class="activator"
                                                 src="{{asset('style/app-assets/images/gallery/3.png')}}"
                                                 alt="user bg"/>
                                        </div>
                                        <div class="card-content">
                                            ...
                                            <h5 class="card-title activator grey-text text-darken-4">{{auth()->user()->username ?? ''}}</h5>
                                            <p><i class="material-icons profile-card-i">perm_identity</i>
                                                {{auth()->user()->username ?? ''}}</p>
                                            <p><i class="material-icons profile-card-i">perm_phone_msg</i> {{auth()->user()->mobile ?? ''}}</p>
                                            <p><i class="material-icons profile-card-i">email</i> {{auth()->user()->email ?? ''}}
                                            </p>
                                        </div>
                                        <div class="card-reveal">
                                            <span class="card-title grey-text text-darken-4">{{auth()->user()->	full_name ?? ''}} <i
                                                    class="material-icons right">close</i>
                                            </span>
{{--                                            <p>Here is some more information about this card.</p>--}}
                                            <p><i class="material-icons">perm_identity</i> {{auth()->user()->username ?? ''}}</p>
                                            <p><i class="material-icons">perm_phone_msg</i>  {{auth()->user()->mobile ?? ''}}</p>
                                            <p><i class="material-icons">email</i>{{auth()->user()->email ?? ''}}</p>
                                            ...
                                            <ul class="widget-timeline mb-0">
                                                ...
                                                <li class="timeline-items timeline-icon-red active">
                                                    ...
                                                    <div class="timeline-content">
                                                        <img src="{{asset('style/app-assets/images/icon/pdf.png')}}"
                            ...
                            <li class="chat-body">
                                <ul class="collection">
                                    <li class="collection-item display-flex avatar pl-5 pb-0"
                                        data-target="slide-out-chat">
                                        <span class="avatar-status avatar-online avatar-50"><img
                                                src="{{asset('style/app-assets/images/avatar/avatar-7.png')}}"
                                                alt="avatar"/>
                                        </span>
    ...
    {{--                        <a href="{{ route('dashboard.services.index') }}" class="small-box-footer">@lang('site.read') <i class="fa fa-arrow-circle-right"></i></a>--}}
    {{--                    @endif--}}
    {{--                    </div>--}}
    {{--                </div>--}}
    ...
    {{--                        <a href="{{ route('dashboard.halls.index') }}" class="small-box-footer">@lang('site.read') <i class="fa fa-arrow-circle-right"></i></a>--}}
    {{--                    @endif--}}
    {{--                    </div>--}}
    {{--                </div>--}}
