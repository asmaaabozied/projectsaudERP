...
<script>
    $(document).ready(function() {
        ...
        $('.myform').submit(function() {
            if (confirm('هل ان متأكد من حذف استلام اصناف من مخزن ؟')) {
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-8 col-12 mb-2">
                    <center>
                        <h3 class="content-header-title font-theme ls-0">استلام اصناف من مخزن
                        </h3>
                    </center>
                </div>
                <div class="content-header-right col-md-4 col-12 mb-2">
                    <a href="{{url('admin/Categoriesstore/create')}}" class="btn btn-primary" ><i class="icon-plus"></i> إضافة </a>
                </div>
                {{--            <div class="content-header-right col-md-4 col-12 mb-2">--}}
