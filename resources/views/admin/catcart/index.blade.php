...
<script>
    $(document).ready(function() {
        ...
        $('.myform').submit(function() {
            if (confirm('هل ان متأكد من حذف كارت الصنف؟')) {
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-8 col-12 mb-2">
                <center>
                <h3 class="content-header-title font-theme ls-0">كارت الصنف
                </h3>
                </center>
            </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-head-fixed text-nowrap table-striped-td table-sm-td text-center datatable" >
                                ...
                                <tr>
                                    <td> <a href="{{(route('catcart.show',$drive->id))}}">{{$drive->name}}</a></td>
                                    <td>{{$drive->number}}</td>
                                    ...
                                    <td>
                                        ...
                                        <form class="myform"  id="{{$drive->id}}"  method="post"  action="{{'catcart/delete/'.$drive->id}}">
                                            @csrf
