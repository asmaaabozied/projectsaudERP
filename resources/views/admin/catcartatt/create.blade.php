                                                        ...
                                                        <tr id="invoicerow_1">
                                                            <td>
                                                                <input type="number" value="1"
                                                                       ...
                                                                       id="quantity_1" onchange="changeQuantity(this,1)" name="barcode[]">
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td><input type="number" data-type="purchase_price"
                                                                       class="form-control bg-transparent border-0 inputs autocomplete_txt"
                                                                        id="price_1" name="purchase_price[]"
                                                                       autocomplete="off"></td>
                                                            <td><input type="number" data-type="sell_price"
                                                                       class="form-control bg-transparent border-0 inputs autocomplete_txt"
                                                                       id="price_1" name="sell_price[]"
                                                                       autocomplete="off"></td>
                    ...
                    var AddMultiAutoField = (function () {
                        ...
                        function formHtml(code) {
                            ...
                            if (code == 13 && rowId == 'invoicerow') {
                                ...
                                html += '<td><select  data-type="barcode" required class="form-control bg-transparent border-0 inputs autocomplete_txt" onchange="selectProduct(this,' + rowcount + ')" id="name_' + rowcount + '" name="barcode[]" autocomplete="off">' +
                                ...
                                html += '<td><select  data-type="unit" class="form-control bg-transparent border-0 inputs autocomplete_txt"  onchange="selectProduct(this,' + rowcount + ')" id="unit_' + rowcount + '" name="unit[]" autocomplete="off">' +
                                    ...
                                    '</select></td>';
                                html += '<td><input type="number" data-type="purchase_price" class="form-control bg-transparent border-0 inputs autocomplete_txt"  id="price_' + rowcount + '" name="purchase_price[]" autocomplete="off"></td>';
                                html += '<td><input type="number" class="form-control bg-transparent border-0 inputs totals sal-lst"  id="total_' + rowcount + '" name="sell_price[]"></td>';
