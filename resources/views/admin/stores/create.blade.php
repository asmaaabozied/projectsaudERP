                ...
                <div class="card">
                    <div class="card-block">
                        ...
                        <div class="card-body">
                            ...
                            <form id="add-form" action="/admin/stores" method="post">
                                @csrf
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-1 text-center order-md-1 order-1">
                                            ...
                                            <h5 class="modal-title"> امر تحويل اصناف المخازن</h5>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                                ...
                                                <div class="card-body table-responsive p-0" style="height:250px;">
                                                    <table class="table table-head-fixed text-nowrap table-striped-td table-input-td text-center"
                                                        ...
                                                        <tr id="invoicerow_1">
                                                            ...
                                                            <td><input type="number" data-type="value"
                                                                       class="form-control bg-transparent border-0 inputs autocomplete_txt"
                                                                        id="price_1" name="value[]"
                                                                       autocomplete="off"></td>
                                                            <td><input type="number" data-type="total"
                                                                       class="form-control bg-transparent border-0 inputs autocomplete_txt"
                                                                       id="price_1" name="total[]"
                                                                       autocomplete="off"></td>
...
{{--                                    </button>--}}
                ...
                <script>
                    var AddMultiAutoField = (function () {
                        ...
                        var options = '';
                        options += '<option value="">اسم الصنف</option>';
                        ...
                        function formHtml(code) {
                            ...
                            if (code == 13 && rowId == 'invoicerow') {
                                ...
                                html += '<td><select  data-type="barcode" required class="form-control bg-transparent border-0 inputs autocomplete_txt" onchange="selectProduct(this,' + rowcount + ')" id="name_' + rowcount + '" name="number[]" autocomplete="off">' +
                                ...
                                html += '<td><select  data-type="unit" class="form-control bg-transparent border-0 inputs autocomplete_txt"  onchange="selectProduct(this,' + rowcount + ')" id="unit_' + rowcount + '" name="unit[]" autocomplete="off">' +
                                    ...
                                    '</select></td>';
                                html += '<td><input type="number" data-type="purchase_price" class="form-control bg-transparent border-0 inputs autocomplete_txt"  id="price_' + rowcount + '" name="value[]" autocomplete="off"></td>';
                                html += '<td><input type="number" class="form-control bg-transparent border-0 inputs totals sal-lst"  id="total_' + rowcount + '" name="total[]"></td>';
