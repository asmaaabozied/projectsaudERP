...
class MarpurchaseController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.marpurchases.create', compact('stores', 'classifications', 'suppliers', 'products'));
    }
    ...
    public function index()
    {
        ...
        $stores = Store::get();
        $suppliers = Suppliers::get();
        $drivers = Marpurchase::where('type','goods')->where('company_id',Auth::user()->company_id)->get();
        return view('admin.marpurchases.index', compact('drivers', 'suppliers', 'stores'));
    }
...
//        $products=Products::all();
    ...
    public function store(Request $request)
    {
        ...
        $cart = Marpurchase::create($request->except('_token', 'name', 'number', 'value', 'quantity', 'size', 'tax','discount','unit')+['type'=>'goods','company_id'=>Auth::user()->company_id]);
