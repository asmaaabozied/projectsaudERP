...
class StoresController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        $slider = Stores::find($id);

        $slider->delete();
        $baku = Store_attribure::where('store_id', $id)->first();
        if ($baku) {
            $baku->delete();
        }
    ...
    public function create()
    {
        ...
        return view('admin.Stores.create', compact('stores', 'classifications', 'suppliers', 'products'));
    }
    ...
    public function index()
    {
        ...
        $stores = Store::get();
        $suppliers = Suppliers::get();
        $drivers = Stores::where('company_id',Auth::user()->company_id)->get();
        return view('admin.Stores.index', compact('drivers', 'suppliers', 'stores'));
    }
...
//        $products=Products::all();
        ...
        return view('admin.Stores.show', compact('driver', 'suppliers', 'stores', 'classifications', 'products'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cart = Stores::create($request->except('_token', 'value', 'quantity', 'unit', 'name', 'total','number')+['company_id'=>Auth::user()->company_id]);
        foreach ($request->name as $key => $value) {
           Store_attribure::create([
