...
class CatcartAttController extends Controller
{

    public function destroy($id)
    {

        $slider = Catcart_attribute::find($id);
...
//        $user=User::find($_SESSION['admin_id']);
    ...
    public function index()
    {
        ...
        $stores = Store::get();
        $suppliers = Suppliers::get();
        $drivers = Catcart_attribute::get();
        return view('admin.catcartatt.index', compact('drivers', 'suppliers', 'stores'));
    }
