...
//            })
            ->addColumn('action', function ($model) {
                ...
                $actions .= DTHelper::dtEditButton(route('dashboard.companies.edit', $model->id), trans('site.edit'), 'dashboard.companies.update');

                $actions .= DTHelper::dtShowButton(route('dashboard.companies.show', $model->id), trans('site.show'), 'dashboard.companies.update');
                $actions .= DTHelper::dtDeleteButton(route('dashboard.companies.destroy', $model->id), trans('site.delete'), $this->getPermissions()['delete']);
...
//                $actions .= DTHelper::dtBlockActivateButton(route('dashboard.locations.destory', $model->id), $model->active);
    ...
    {
        return Company::where('parent_id', '=', 1)->newQuery();
    }
